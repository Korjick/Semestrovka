    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="signInModalLabel">Please, Sign In:</h5>
            ...
            <form action="">
                <div class="modal-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control" id="inputEmailSignIn" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputPasswordSignIn" class="col-sm-4 col-form-label">Password</label>
                        <div class="col-sm-10">
                            <input type="password" class="form-control" id="inputPasswordSignIn" required>
                        </div>
                    </div>
            ...
            <form action="">
                <div class="modal-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control" id="inputEmailSignUp" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputPasswordSignUp" class="col-sm-4 col-form-label">Password</label>
                        <div class="col-sm-10">
                            <input type="password" class="form-control" id="inputPasswordSignUp" required>
                        </div>
                    </div>
                    <div class="row mb-3">
